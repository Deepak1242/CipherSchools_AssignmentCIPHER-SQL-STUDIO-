...
const { executeUserQuery, getHint, validateUserQuery, executePlaygroundQuery } = require('../controllers/queryController');
...
router.post('/playground', auth, queryLimiter, executePlaygroundQuery);
